...
| tests/test_os_globe_high_resolution.py | 普通海域、任务领取后的普通海域、两种红色警告普通海域、卡利比安海 D、隐蔽海域及颜色保护的 7 项高分辨率回归测试 |
...
当前预期是分辨率 10 项、高分辨率大世界识别 7 项、G.M. 指令页识别 3 项、更新器 10 项，共 30 项通过。
...
7. 运行 30 项自动测试、py_compile 和必要的模拟器冒烟测试。
